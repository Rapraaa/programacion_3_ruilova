...
describe('CategoriesService', () => {
  ...
  describe('create()', () => {
    it('should create and return a category', async () => {
      ...
      expect(await service.create({ name: 'Tecnología' })).toEqual(
        mockCategory,
      );
    });
  ...
  describe('update()', () => {
    ...
    it('should update and return the category', async () => {
      ...
      expect(await service.update(CATEGORY_ID, { name: 'Nuevo' })).toEqual({
        id: CATEGORY_ID,
        name: 'Nuevo',
      });
    });
  ...
  describe('remove()', () => {
    ...
    it('should return null when remove throws', async () => {
      ...
      mockCategoryRepository.remove.mockRejectedValue(
  ...
  describe('findAll()', () => {
    const mockPaginationResult = {
      items: [
        { id: CATEGORY_ID, name: 'Tech' },
        { id: CATEGORY_ID_2, name: 'Ciencia' },
      ],
      meta: {
        currentPage: 1,
        totalPages: 1,

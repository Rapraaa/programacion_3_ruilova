export default function LabTwButtons_mp() {
  return (
    <main className="min-h-screen bg-slate-950 text-white p-8">
      <h2 className="text-xl font-extrabold mb-1">LAB: Botones de la clinica</h2>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button className="rounded-xl bg-emerald-600 px-6 py-3 text-lg font-semibold hover:bg-emerald-500 transition">
          Grande
        </button>
        <button className="rounded-xl bg-emerald-600 px-4 py-2 font-semibold hover:bg-emerald-500 transition">
          Normal
        </button>
        <button className="rounded-xl bg-emerald-600 px-3 py-1 text-sm font-semibold hover:bg-emerald-500 transition">
          Pequeño
        </button>
        <button
          disabled
          className="rounded-xl bg-emerald-600 px-4 py-2 font-semibold opacity-40 cursor-not-allowed"
        >
          Sin turnos
        </button>
      </div>

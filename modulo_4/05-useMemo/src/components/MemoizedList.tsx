  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#666", fontSize: 14, marginBottom: 20 }}>
        <code>React.memo</code> + <code>useCallback</code> — las filas no
        re-renderizan por un counter ajeno.
      </p>
      ...
      <p style={{ marginTop: 16, fontSize: 12, color: "#aaa" }}>
        Render total de filas: {rowRenderCount} (debería crecer solo al hacer
        toggle o delete, no al pulsar el counter)
      </p>
    </div>
  );
}

...
const ARTICLES: Article[] = [
  ...
  {
    id: 2,
    title: "TypeScript con React: guía práctica",
    tags: ["typescript", "react", "guía"],
    views: 3100,
  },
  {
    id: 3,
    title: "useMemo y useCallback explicados",
  ...
  },
  {
    ...
    tags: ["css", "estilos", "react"],
    views: 1900,
  },
  {
    id: 5,
    title: "TanStack Query desde cero",
    tags: ["react", "fetch", "tutorial"],
    views: 5100,
  },
  {
    id: 6,
    title: "Testing con Vitest y Testing Library",
    tags: ["testing", "react", "tutorial"],
    views: 2200,
  },
  {
    id: 7,
    title: "Performance en React: técnicas clave",
    tags: ["react", "performance", "hooks"],
    views: 3600,
  },
  {
    id: 8,
    title: "TypeScript strict mode explicado",
    tags: ["typescript", "guía"],
    views: 1500,
  },
];
  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#666", fontSize: 14, marginBottom: 20 }}>
        Tags múltiples con filtro AND. Conteos memoizados — se calculan una sola
        vez.
      </p>

  ...
  return (
    ...
    >
      ...
      <p style={{ color: "#666", fontSize: 14, marginBottom: 20 }}>
        El contador provoca re-renders — el cribado solo recorre cuando cambia
        el límite.
      </p>
      ...
      >
        {[
          {
            label: "Primos encontrados",
            value: primes.length.toLocaleString(),
          },
          { label: "Límite", value: limit.toLocaleString() },
          {
            label: "Mayor primo",
            value: (primes.at(-1) ?? 0).toLocaleString(),
          },
        ].map(({ label, value }) => (
          <div
            key={label}
